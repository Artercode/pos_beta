...
<body class="no-skin">
		...
		<!--[if !IE]> -->
		<script src="<?php echo base_url("resources/assets/js/jquery-2.1.4.min.js");?>"></script>
...
<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='<?php echo base_url("resources/assets/js/jquery.mobile.custom.min.js");?> >"+"<"+"/script>");
		</script>
		<script src="<?php echo base_url("resources/assets/js/bootstrap.min.js")?>"></script>
		<!-- ace scripts -->
		<script src="<?php echo base_url("resources/assets/js/ace-elements.min.js");?>"></script>
		<script src="<?php echo base_url("resources/assets/js/ace.min.js");?>"></script>
