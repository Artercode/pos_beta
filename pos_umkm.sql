...
--
-- Table structure for table `trx_pejualan`
--

CREATE TABLE `trx_pejualan` (
...
INSERT INTO `trx_pembelian` (`id_pembelian`, `kd_trx_pembelian`, `kd_produk`, `nama_barang`, `harga`, `qty`, `total`, `diskon`, `kd_satuan`, `supplier`, `created_date`) VALUES
(1, 'BL0001', 'BRS0001', 'Beras Bramo', 58000, 10, 580000, 0, NULL, 1, '2020-04-25'),
(2, 'BL0002', 'BRS0001', NULL, 58000, 5, 290000, 0, NULL, NULL, '2020-04-25');
...
--
-- Indexes for table `trx_pejualan`
--
ALTER TABLE `trx_pejualan`
